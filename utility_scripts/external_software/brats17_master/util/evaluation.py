...
import os
import numpy as np
from utility_scripts.external_software.brats17_master.util.data_process import load_3d_volume_as_array, binary_dice3d
...
if __name__ == '__main__':
    ...
    for type_idx in range(3):
        ...
        np.savetxt(s_folder + '/dice_{0:}.txt'.format(test_type), int(dice))
